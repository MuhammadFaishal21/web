                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
										<?php 
											if(isset($_POST['login'])){
												...
												$sql 		= "select * from lurah where email='".$email."' and password='".$password."'";
												...
												if($query){
													...
													if($row > 0){
														...
														$_SESSION['id_lurah']= $rows['id_lurah'];
                                        ...
                                        <div class="card-header pb-1">
                                            <div class="card-title">
												<h4 class="text-center mb-2"><img src="../assets/logo.png" width="100" alt=""/><br><br>Lurah Login</h4>
                                            </div>
                                        </div>

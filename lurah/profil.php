                ...
                <section id="basic-tabs-components">
					<?php 
								...
								if(isset($_POST['bio'])){
									...
									$email			= $_POST['email'];
									$no_hp			= $_POST['no_hp'];
									$input  		= "update lurah set nama ='" . $nama . "', email ='" . $email . "', no_hp ='" . $no_hp . "' where id_lurah ='" . $_SESSION['id_lurah'] . "'";
								...
								if(!empty($_POST['currentPassword'])){
									...
									$result = mysql_query("select * from lurah where id_lurah ='". $_SESSION['id_lurah'] ."'");
									...
									mysql_query("update lurah set password='" . $newpassword . "' where id_lurah ='". $_SESSION['id_lurah'] ."'");
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
								...
								<?php
									$no = 0;
									$query = mysql_query("select * from lurah where id_lurah='". $_SESSION['id_lurah'] ."'");
                                    ...
                                    <div class="tab-pane active col-6" id="home" aria-labelledby="home-tab" role="tabpanel">
                                        ...
                                        <div class="modal-body">
											<fieldset class="form-group">
												<label for="basicInput">Nama Lurah</label>
												<input type="text" class="form-control" id="basicInput" name="nama" value="<?php echo $row['nama']; ?>" placeholder="isi nama lengkap lurah">
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Alamat Email</label>
												<input type="email" class="form-control" id="basicInput" name="email" value="<?php echo $row['email']; ?>" placeholder="isi alamat email lurah">
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Nomor Ponsel</label>
												<input type="text" class="form-control" id="basicInput" name="no_hp" value="<?php echo $row['no_hp']; ?>" placeholder="isi nomor ponsel lurah">
											</fieldset>
										</div>

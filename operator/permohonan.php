											...
											function tanggal_indo($tanggal)
											{
												...
												return $split[2] . ' ' . $bulan[ (int)$split[1] ] . ' ' . $split[0];
														...
														if(isset($_POST['terima'])){
															...
															$input  		= "update permohonan set status ='MENUNGGU VALIDASI LURAH' where id_permohonan ='" . $id_permohonan . "'";
															$query_input 	= mysql_query($input);
															if($query_input) {
															$sukses = "<div class='alert alert-success' role='alert'><strong>Well done! </strong>Data Permohonan <strong>$nomor</strong> berhasil diproses dan dikirim ke kepala lurah</div><br>";
														...
														if(isset($_POST['cetak'])){
															$nomor	 		= $_POST['nomor'];
															$id_permohonan	= $_POST['id_permohonan'];
															$input  		= "update permohonan set status ='DITERBITKAN' where id_permohonan ='" . $id_permohonan . "'";
															$query_input 	= mysql_query($input);
															if($query_input) {
															$sukses = "<div class='alert alert-success' role='alert'><strong>Well done! </strong>Data Permohonan <strong>$nomor</strong> berhasil diterbitkan</div><br>";
															} else $gagal = "<div class='alert alert-danger' role='alert'><strong>Oh snap! </strong>Proses Data Permohonan GAGAL ! Mohon periksa kembali</div>".mysql_error();
														}
														...
														if(isset($_POST['selesai'])){
															$nomor	 		= $_POST['nomor'];
															$id_permohonan	= $_POST['id_permohonan'];
															$input  		= "update permohonan set status ='SELESAI' where id_permohonan ='" . $id_permohonan . "'";
															$query_input 	= mysql_query($input);
															if($query_input) {
															$sukses = "<div class='alert alert-success' role='alert'><strong>Well done! </strong>Data Permohonan <strong>$nomor</strong> telah selesai diproses</div><br>";
															} else $gagal = "<div class='alert alert-danger' role='alert'><strong>Oh snap! </strong>Proses Data Permohonan GAGAL ! Mohon periksa kembali</div>".mysql_error();
														}
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
														...
														<td>
															...
															<?php } ?>
															<?php 
																if($row['status']=='PROSES CETAK DOKUMEN'){
															?>
															<button type="button" class="btn btn-icon btn-outline-success mr-1 mb-1" data-toggle="modal" data-target="#cetak<?php echo $no; ?>"><i class="bx bx-check"></i></button>
															<?php } ?>
															<?php 
																if($row['status']=='DITERBITKAN'){
															?>
															<button type="button" class="btn btn-icon btn-outline-success mr-1 mb-1" data-toggle="modal" data-target="#selesai<?php echo $no; ?>"><i class="bx bx-check"></i></button>
															<?php } ?>
														</td>
                                                    </tr>
													...
													<div class="modal fade text-left" id="terima<?php echo $no; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
														...
														<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<h5>Yakin akan melanjutkan proses permohonan <strong><?php echo $prx; ?>-00<?php echo $row['id_permohonan']; ?></strong> dan meneruskannya ke kepala lurah ? <br><br><strong>NOTE : Pastikan semua berkas permohonan telah di verifikasi !</strong></h5>
													...
													<div class="modal fade text-left" id="cetak<?php echo $no; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
														<form action="" method="post">
														<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
															<div class="modal-content">
																<div class="modal-header bg-success">
																	<h4 class="modal-title text-white" id="myModalLabel17">Penerbitan Dokumen</h4>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<i class="bx bx-x"></i>
																	</button>
																</div>
																<div class="modal-body">
																	<h5>Yakin akan menerbitkan proses permohonan <strong><?php echo $prx; ?>-00<?php echo $row['id_permohonan']; ?></strong> dan meneruskannya ke penduduk ? <br><br><strong>NOTE : Pastikan dokumen telah siap untuk diambil oleh penduduk di kelurahan !</strong></h5>
																	<input type="hidden" name="id_permohonan" value="<?php echo $row['id_permohonan']; ?>">
																	<input type="hidden" name="nomor" value="<?php echo $prx; ?>-00<?php echo $row['id_permohonan']; ?>">
																</div>
																<div class="modal-footer">
																	...
																	<button type="submit" name="cetak" class="btn btn-success ml-1" >
																		<i class="bx bx-check d-block d-sm-none"></i>
													...
													<div class="modal fade text-left" id="selesai<?php echo $no; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
														<form action="" method="post">
														<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
															<div class="modal-content">
																<div class="modal-header bg-success">
																	<h4 class="modal-title text-white" id="myModalLabel17">Pengambilan Dokumen</h4>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<i class="bx bx-x"></i>
																	</button>
																</div>
																<div class="modal-body">
																	<h5>Yakin akan merubah status proses permohonan <strong><?php echo $prx; ?>-00<?php echo $row['id_permohonan']; ?></strong> menjadi selesai ? <br><br><strong>NOTE : Pastikan dokumen telah diambil oleh penduduk !</strong></h5>
																	<input type="hidden" name="id_permohonan" value="<?php echo $row['id_permohonan']; ?>">
																	<input type="hidden" name="nomor" value="<?php echo $prx; ?>-00<?php echo $row['id_permohonan']; ?>">
																</div>
																<div class="modal-footer">
																	...
																	<button type="submit" name="selesai" class="btn btn-success ml-1" >
																		<i class="bx bx-check d-block d-sm-none"></i>

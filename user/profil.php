                ...
                <section id="basic-tabs-components">
					<?php 
								...
								if(isset($_POST['bio'])){
									$email			= $_POST['email'];
									$no_hp			= $_POST['no_hp'];
									$input  		= "update user set email ='" . $email . "', no_hp ='" . $no_hp . "' where id_user ='" . $_SESSION['id_user'] . "'";
								...
								if(!empty($_POST['currentPassword'])){
									...
									mysql_query("update user set password='" . $newpassword . "' where id_user ='". $_SESSION['id_user'] ."'");
                        ...
                        <div class="card-content">
                            <div class="card-body">
								...
								<?php
									...
									$no = 0;
									$query = mysql_query("select * from penduduk where id_user='". $_SESSION['id_user'] ."'");
                                    ...
                                    <div class="tab-pane active col-6" id="home" aria-labelledby="home-tab" role="tabpanel">
                                        ...
                                        <div class="modal-body">
											<fieldset class="form-group">
												<label for="basicInput">Nomor Induk Kependudukan (NIK)</label>
												<input type="text" class="form-control" id="basicInput" value="<?php echo $row['nik']; ?>"readonly>
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Nama Penduduk</label>
												<input type="text" class="form-control" id="basicInput" value="<?php echo $row['nama']; ?>"readonly>
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Tempat Tanggal Lahir</label>
												<input type="text" class="form-control" id="basicInput" value="<?php echo $row['kota_lahir']; ?>, <?php echo tanggal_indo($row['tanggal_lahir']); ?>"readonly>
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Agama</label>
												<input type="text" class="form-control" id="basicInput" value="<?php echo $row['agama']; ?>"readonly>
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Status Pernikahan</label>
												<input type="text" class="form-control" id="basicInput" value="<?php echo $row['status_nikah']; ?>"readonly>
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Status Dalam Keluarga</label>
												<input type="text" class="form-control" id="basicInput" value="<?php echo $row['shdk']; ?>"readonly>
											</fieldset>
											<?php
												$query1 = mysql_query("select * from user where id_user='". $_SESSION['id_user'] ."'");
												while ($row1 = mysql_fetch_array($query1)) {
											?>
											<fieldset class="form-group">
												<label for="basicInput">Alamat Email</label>
												<input type="email" class="form-control" id="basicInput" name="email" value="<?php echo $row1['email']; ?>" placeholder="isi alamat email anda">
											</fieldset>
											<fieldset class="form-group">
												<label for="basicInput">Nomor Handphone</label>
												<input type="text" class="form-control" id="basicInput" name="no_hp" value="<?php echo $row1['no_hp']; ?>" placeholder="isi nomor ponsel anda">
											</fieldset>
											<?php } ?>
										</div>

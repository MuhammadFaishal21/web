                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
										<?php 
											if(isset($_POST['login'])){
												...
												if($query){
													...
													if($row > 0){
														$sql1 		= "select * from penduduk where id_penduduk='".$rows['id_penduduk']."'";
														$query1 	= mysql_query($sql1) or die (mysql_error());
														$row1		= mysql_fetch_array($query1);
														$_SESSION['isLoggedIn']=2;
														$_SESSION['email']=$email;
														$_SESSION['id_user']= $rows['id_user'];
														$_SESSION['id_penduduk']= $row1['id_penduduk'];
														...
														"<div class='alert alert-danger alert-dismissable'>
															...
															<h5 align='center' class='text-white'>Email atau Password anda <br>SALAH atau BELUM TERDAFTAR ! <br>silahkan ulangi kembali</h5>
														</div>";
														}
													}
											}
                                        ...
                                        <div class="card-header pb-1">
                                            <div class="card-title">
												<h4 class="text-center mb-2"><img src="../assets/logo.png" width="100" alt=""/><br><br>Login Kependudukan</h4>
                                            </div>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <hr>
												<div class="text-center"><small class="mr-25">Belum punya akun ?</small><a href="register.php"><small>DAFTAR SEKARANG !</small></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.php">
                        ...
                        <h2 class="brand-text mb-0">Handil Bakti</h2>
                    </a></li>
            </ul>
        </div>
                            ...
                            <div class="row  ">
                                ...
                                <div class="col-12">
                                    <div class="row">
										...
										<?php
											$query = mysql_query("select count(*) as hasil from permohonan where id_penduduk='". $_SESSION['id_penduduk'] ."'");
										...
										<?php } ?>
										<?php
											$query = mysql_query("select count(*) as hasil from permohonan where status='SELESAI' and id_penduduk='". $_SESSION['id_penduduk'] ."'");
											while ($row = mysql_fetch_array($query)) {
										?>
										<div class="col-sm-3 col-12 dashboard-users-danger">
                                            <div class="card text-center">
